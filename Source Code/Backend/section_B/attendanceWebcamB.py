...
def captureImages(name, num_images=15):
    ...
    while count < num_images:
        ...
        if key == 32 and fits_in_circle:  # Press SpaceBar to capture if face fits
            count += 1
            cv2.imwrite(f'C:\\Users\\HP\\OneDrive\\Desktop\\Attendance-Face-Detection-master\\Attendance-Face-Detection-master\\Attendance-Face-Detection-master\\section_B\\database_B/{name}_{count}.jpg', frame)  # Save the original frame without instructions
...
def startWebcam():
    path = 'C:\\Users\\HP\\OneDrive\\Desktop\\Attendance-Face-Detection-master\\Attendance-Face-Detection-master\\Attendance-Face-Detection-master\\section_B\\database_B'
    imageList = []
    personName = []
